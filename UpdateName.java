  ...
  public void init() throws ServletException {
					...
					try 
	{
      if (PERSONID.length() == 0 || NAME.length() == 0) {
        out.println("Please: Owner ID and Name are required");
        return; 
    }
		...
		out.print( "<br /><b><center><font color=\"RED\"><H2>The following address has been updated in the database:</H2></font>");
